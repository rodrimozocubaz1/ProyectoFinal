...
if(isset($_POST["b"])){
    ...
    #insertar el id del taller y del usuario en la tabla vacunas_usuario
    ...
    header("Location: ../paginas/info_vacunacion.php")
    exit();
    ...
    $sql="DELETE $tab_vacuna_usuario WHERE $idVac_vacuna_usuario='$id_v' AND $idUsu_vacuna_usuario='$id_u')";
